 ...
 * implementation details used by sibling @averspec/* packages and tests.
 * Import from '@averspec/core/internals' to keep your imports explicit.
 * These are NOT re-exported from '@averspec/core' — use this subpath entry.
 */
export {
  registerDomain,
  registerAdapter,
